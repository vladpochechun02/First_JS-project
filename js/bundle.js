...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wpapper, field}) {
	// Slider
	...
	const slides = document.querySelectorAll(slide),
		...
		slidesWrapper = document.querySelector(wpapper),
...
window.addEventListener('DOMContentLoaded', () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer', '2023-05-05');
